...
<head>
    ...
    <title>Message Sent - Aero Jobs</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Tahoma, sans-serif; }
        ...
        /* Contact Success Theme (Purple/Cyan mix) */
        .status-card { background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(224, 0, 255, 0.3); border-radius: 20px; padding: 50px; width: 100%; max-width: 500px; text-align: center; backdrop-filter: blur(15px); box-shadow: 0 15px 35px rgba(224, 0, 255, 0.15); animation: fadeInUp 0.6s ease-out; }
        .ambient-glow { position: absolute; width: 300px; height: 300px; background: #e000ff; border-radius: 50%; filter: blur(150px); z-index: -1; opacity: 0.2; }

        .icon { font-size: 70px; margin-bottom: 20px; color: #e000ff; text-shadow: 0 0 20px rgba(224, 0, 255, 0.6); }
        h1 { font-size: 2rem; margin-bottom: 15px; color: #e000ff; }
...
<div class="container">
    ...
    <div class="status-card">
        ...
        <p>Your message has been delivered to the Aero Jobs network team. We will respond shortly.</p>
