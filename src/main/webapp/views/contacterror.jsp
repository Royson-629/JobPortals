...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Tahoma, sans-serif; }
        ...
        /* Error Theme */
        .status-card { background: rgba(255, 102, 0, 0.03); border: 1px solid rgba(255, 102, 0, 0.3); border-radius: 20px; padding: 50px; width: 100%; max-width: 500px; text-align: center; backdrop-filter: blur(15px); box-shadow: 0 15px 35px rgba(255, 102, 0, 0.15); animation: fadeInUp 0.6s ease-out; }
        .ambient-glow { position: absolute; width: 300px; height: 300px; background: #ff6600; border-radius: 50%; filter: blur(150px); z-index: -1; opacity: 0.2; }

        .icon { font-size: 70px; margin-bottom: 20px; color: #ff6600; text-shadow: 0 0 20px rgba(255, 102, 0, 0.6); }
        h1 { font-size: 2rem; margin-bottom: 15px; color: #ff6600; }
        p { color: #cbd5e1; margin-bottom: 30px; font-size: 1.1rem; line-height: 1.5; }

        .btn { display: inline-block; background: transparent; color: #ff6600; border: 2px solid #ff6600; padding: 12px 30px; border-radius: 30px; text-decoration: none; font-weight: bold; transition: 0.3s; box-shadow: 0 0 10px rgba(255, 102, 0, 0.2); }
        .btn:hover { background: #ff6600; color: #fff; box-shadow: 0 0 20px rgba(255, 102, 0, 0.6); transform: translateY(-3px); }
...
<div class="container">
    ...
    <div class="status-card">
        <div class="icon">⚠</div>
        <h1>Signal Lost</h1>
        <p>We could not send your message due to a server disruption. Please attempt your transmission again.</p>
        <a href="/contact" class="btn">Retry Transmission</a>
    </div>
</div>
</body>
</html>