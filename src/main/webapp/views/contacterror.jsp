    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        body {
            ...
            background-image: radial-gradient(at 50% 50%, rgba(239, 68, 68, 0.06) 0px, transparent 60%);
            color: var(--text-dark);
            min-height: 100vh;
            display: flex;
...
<div class="container">
    <div class="status-card">
        <div class="icon">⚠</div>
        <h1>Delivery Interrupted</h1>
        <p>We could not dispatch your message due to a temporary network disruption. Please retry.</p>
